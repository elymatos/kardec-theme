...
<form <?php echo tag_attributes($formAttributes); ?>>
  <div class="ui top attached tabular menu">
    <a class="active item" data-tab="first">Pesquisa Simples</a>
    <a class="item" data-tab="second">Pesquisa Avançada</a>
    <a class="item" data-tab="third">Ver Palavras-Chave</a>
  </div>
  <!-- first -->
  <div class="ui bottom attached active tab segment" data-tab="first">
    <?php echo $this->partial('items/search-form-simple.php',
      array('formAttributes' =>
        array('id' => 'simple-search-form'))); ?>
  </div>
  <!-- second -->
  <div class="ui bottom attached tab segment" data-tab="second">
    <!--
    <div id="search-keywords" class="field">
      <?php echo $this->formLabel('keyword-search', __('Ver Palavras-Chave')); ?>
      <div class="inputs">
        <?php
        echo $this->formText(
          'search',
  ...
  <div class="ui bottom attached tab segment" data-tab="third" style="text-align: left">
    <?php echo tag_cloud(get_records('Tag', array(), 0), 'items/browse'); ?>
  </div>
